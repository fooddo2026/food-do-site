  ...
  return (
    <div className="w-64 bg-white border-r border-gray-100 flex flex-col h-full relative">
      ...
      <div className="p-6 border-b border-gray-50">
        <h1 className="text-2xl font-medium text-primary tracking-tight">FOOD-DO</h1>
      ...
      <nav className="flex-1 px-4 space-y-1.5 mt-6">
        {userRole?.toUpperCase() === 'ADMIN' ? (
          <>
            ...
            <Link to="/analytics" className={linkClass('/analytics')} onClick={handleLinkClick}>
              Analytics
            </Link>
            <Link to="/staff-terminal" className={linkClass('/staff-terminal')} onClick={handleLinkClick}>
              Staff Terminal
            </Link>
          </>
